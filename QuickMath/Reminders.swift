...
enum Reminders {
    private static let identifier = "carryover.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Your loose ends are waiting."
        content.body = "Open Carryover to review what you carried forward from yesterday."
